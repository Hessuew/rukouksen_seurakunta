...
export const ui = {
  en: {
    podcasts: 'Podcasts',
    prayerChurchImageAlt: 'Prayer church logo, church in Kuopio',
    prayerChurchImageText: 'Church in Kuopio, here we pray | Prayer church logo',
    prayer: 'Prayer',
    church: 'Church',
    ...
    address: 'Address',
    address2: 'We join UEF Student Bible Club meeting in Savilahti, Kuopio',
    time: 'Time',
    time1: 'Saturday 6pm',
    time2: 'Sunday 1pm - (4pm)',
    phone: 'Phone: ',
    phone2: '046 5714 634',
    email: 'Email: ',
    email2: 'rukouksenseurakunta@gmail.com',
    rightsReserved: `Prayer Church reserves the right to publish written feedback (positive or negative, all or excerpt, and writer's name) received on her activities for the sake of transparency and holiness. We have nothing to hide. Glory be to God. Amen.`,
    ...
    juhaniJuusolaImageAlt: 'Image of bishop Juhani Juusola of Church in Kuopio',
    mahidere: 'Pastor Mahidere',
    mahidereImageAlt: 'Image of pastor Mahidere of Church in Kuopio',
    cj: 'Deacon CJ',
    cjImageAlt: 'Image of deacon CJ of Church in Kuopio',
    greta: 'Pastor Greta',
    ...
    akosuaImageAlt: 'Image of pastor Akosua of Church in Kuopio',
    ida: 'Intercessor Ida',
    ...
    idaImageAlt: 'Image of Intercessor Ida of Church in Kuopio',
    ben: 'Deacon Abraham',
    benImageAlt: 'Image of deacon Abraham of Church in Kuopio',
...
Thank you, Jesus!
    ...
    'stats1.title1': 'Regular attendees at gatherings',
    'stats1.title2': 'Heard the gospel',
    'stats1.title3': 'Received Jesus',
    'stats1.title4': 'Prodigal sons repented',
    'stats2.title1': 'Evangelistic events per year',
    'stats2.title2': 'In addition reached with media',
    'stats2.title3': 'Prayer meeting duration',
    'stats2.title4': 'Prodigal sons repented',
    forYou: 'For you',
    ...
    prayerConferenceImageAlt: 'Easter Prayer Conference',
    prayerConferenceImageText:
    ...
    winterRevivalTitle2025: 'Jesus Fest Winter Revival 2025',
    winterRevivalImageText:
      'Jesus Fest Winter Revival 2025 - Prayer, word, salvations, repentance, miracles and sings.',
    prayerConference2026ImageAlt: 'Easter Prayer Conference 2026 flyer',
    ...
    podcasts: 'Podkastit',
    prayerChurchImageAlt: 'Rukouksen seurakunnan logo, seurakunta Kuopio',
    prayerChurchImageText: 'Seurakunta Kuopio, täällä rukoillaan | Rukouksen seurakunnan logo',
    prayer: 'Rukouksen',
    church: 'seurakunta',
    prayerDefinesTheChurch:
      'Seurakunta kuopio - Täällä rukoillaan. <br /> Rukous määrittää seurakunnan elävyyden. Miksi? Koska Jeesus sanoi niin,',
    ...
    address: 'Osoite',
    address2: 'Osallistumme UEF Raamattukerhon tapaamiseen. Savilahti, Kuopio',
    time: 'Aika',
    time1: 'Lauantai klo 18',
    time2: 'Sunnuntai klo 13 - (16)',
    phone: 'Puh: ',
    phone2: '046 5714 634',
    email: 'Sähköposti: ',
    email2: 'rukouksenseurakunta@gmail.com',
    rightsReserved: `Rukouksen seurakunta pidättää kaikki oikeudet julkaista kaikki kirjoitetut arvostelut (positiiviset tai negatiiviset, koko kirjoitus tai sen osa, sekä kirjoittajan nimi) joita olemme vastaanottaneet. Teemme näin täyden läpinäkyvyyden sekä pyhyyden nimissä. Meillä ei ole mitään piiloteltavaa. Kirkkaus Jumalalle. Aamen.`,
    rightsReserved2: `Prayer Church reserves the right to publish written feedback (positive or negative, all or excerpt, and writer's name) received on her activities for the sake of transparency and holiness. We have nothing to hide. Glory be to God. Amen.`,
    ...
    preachingTheGospelDescription3: `Jeesus tuli heidän luokseen ja sanoi heille: "Minulle on annettu kaikki valta taivaassa ja maan päällä. Menkää siis ja tehkää kaikista kansoista minun opetuslapsiani. Kastakaa heidät Isän ja Pojan ja Pyhän Hengen nimeen ja opettakaa heitä pitämään kaikki, mitä minä olen käskenyt teidän pitää. Ja katso, minä olen teidän kanssenne joka päivä maailmanajan loppuun saakka."' Matteus 28:18-20.`,
    ...
    juhaniJuusolaContent2: `Sinut on kutsuttu, Jumalan kirkkaus on sinun päälläsi. Ole uskollinen siinä vähässä, mitä sinulle on annettu äläkä anna mitään tekosyitä. Jumala on asettanut sinut kämmenelleen käyttääkseen sinua ja Hän tulee kasvattamaan sinua. Kyse ei ole sinun kirkkaudestasi vaan Jeesuksen nimen ja tuomisesta esille. Älä laita kutsuasi sivuun edes hetkeksi, vaan tee siitä varma ja selkeä, sillä Jumala tulee kirkastumaan elämäsi kautta.`,
    ...
    juhaniJuusolaImageAlt: 'Kuva Juhani Juusola - Seurakunta Kuopio',
    mahidere: 'Pastori Mahidere',
    mahidereImageAlt: 'Kuva Mahidere - Seurakunta Kuopio',
    cj: 'Seurakunnan palvelija CJ',
    cjImageAlt: 'Kuva CJ - Seurakunta Kuopio',
    greta: 'Pastori Greta',
    ...
    akosuaImageAlt: 'Kuva pastori Akosua - Seurakunta Kuopio',
    ida: 'Esirukoilija Ida',
    idaImageAlt: 'Esirukoilija Ida - Seurakunta Kuopio',
    ...
    ben: 'Deacon Abraham',
    benImageAlt: 'Kuva deacon Abraham - Seurakunta Kuopio',
...
On aivan ihmeellistä, että minut on vapautettu, jotta voin nyt vapauttaa muita. Kiitos Jeesus!
    ...
    'stats1.title1': 'Vakiokävijää kokoontumisissa',
    'stats1.title2': 'Kuullut envakeliumin',
    'stats1.title3': 'Ottanut Jeesuksen vastaan',
    'stats1.title4': 'Parannuksen tehnyttä tuhlaajapoikaa',
    'stats2.title1': 'Evankeliointi tapahtumaa vuodessa',
    'stats2.title2': 'Tavoitettu lisäksi medialla',
    'stats2.title3': 'Rukouskokouksen kesto',
    forYou: 'Sinulle',
    ...
    prayerConferenceImageAlt: 'Pääsiäisen rukouskonferenssi 2025',
    prayerConferenceImageText:
    ...
    winterRevivalTitle2025: 'Jesus Fest Talvi Herätys 2025',
    winterRevivalImageText:
      'Jesus Fest Talvi Herätys 2025 - Rukousta, sanaa, pelastumisia, parannuksen tekoa, ihmeitä ja merkkejä.',
    prayerConference2026ImageAlt: 'Pääsiäisen Rukouskoferenssi 2026 flyer',
    ...
    podcastSubtitle:
      'Kaikki eivät puhu tai ymmärrä englantia. Siksi halusimme tehdä näistä Hengen täyteisistä Raamiksista ja muista tapahtumista suomennoksen, jotta myös suomenkieliset pääsevät osallisiksi näistä taivaallisista ilmestyksistä. Olemme myös itse tulleet aivan valtavan siunatuiksi kuvatessamme näitä, sillä Pyhä Henki on ollut kuvaussessioiden vetäjä. Hallelujah!',
    events: 'Tapahtumat',
    videos: 'Videot',
